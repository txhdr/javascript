...
if (lados < 3){
    console.log('isso não é um polígono')
}
else if ( lados == 3){
    console.log(`Isso é um triangulo. O comprimento é de ${comprimento} cm e tem uma área de ${area} cm.`)
} 
else if(lados == 4){
    console.log(`Isso é um Quadrado. O comprimento é de ${comprimento} cm e tem uma área de ${area} cm.`)
}
else if (lados == 5){
    console.log(`Isso é um Pentágono. O comprimento é de ${comprimento} cm e tem uma área de ${area} cm.`)
} else if (lados > 5){
